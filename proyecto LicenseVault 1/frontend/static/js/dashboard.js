// dashboard.js — FIX #5: skeleton loader
async function renderDashboard() {
  const page = document.getElementById('page-dashboard');

  // FIX #5: mostrar skeleton inmediatamente mientras carga
  page.innerHTML = `
  ...
  try {
    ...
    page.innerHTML = `<p style="color:var(--red);padding:2rem">Error cargando dashboard: ${e.message}</p>`;
  }
}