...
async function renderProductos() {
  ...
  page.innerHTML = `
    ...
    <div class="table-wrap">
      ...
      <div id="prodTableBody"><div class="loading">cargando...</div></div>
    </div>`;
  await loadProductos();
}
        ...
        ${slice.map(p => {
          ...
          return `<tr>
            ...
            <td>
              ...
              <button class="btn btn-danger btn-sm" onclick="confirmarBorrarProducto('${id}','${p.nombre}')">✕</button>
            </td>
          </tr>`;
        }).join('')}
      </tbody>
  ...
  openModal('Nuevo Producto', `
    ...
    <div class="form-row">
      ...
      <div class="form-group"><label>Precio (USD)</label>
        <input class="form-control" id="pPrecio" type="number" min="0" step="0.01" placeholder="99.00"></div>
    </div>
  ...
  openModal('Editar Producto', `
    ...
    <div class="form-row">
      ...
      <div class="form-group"><label>Precio</label>
        <input class="form-control" id="epPrecio" type="number" value="${p.precio}"></div>
    </div>
    <div class="form-row">
      <div class="form-group"><label>Stock</label>
        <input class="form-control" id="epStock" type="number" value="${p.stock}"></div>
